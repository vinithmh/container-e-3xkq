...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-e-3xkq.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-e-3xkq.containers.anotherwebservice.com/
...
```
git clone git@github.com:vinithmh/container-e-3xkq.git
cd container-e-3xkq
```
...
```
docker attach container-e-3xkq
```
